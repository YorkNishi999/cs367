...
public class HashTable<T> {
    ...
    public HashTable(int initSize, double loadFactor) {
    		...
    		this.maxSize = (int) ((int)initSize*loadFactor);
...
//		this.loadFactor = loadFactor;
//		this.maxSize = (int) ((int)initSize*loadFactor);
//		this.arr = new LinkedList[initSize][maxChainLength];
//		int i = 0;
//		while( i < initSize) {
//			arr[i] = new LinkedList<T>[maxChainLength];
//		}
    } //end of constructor
    
    private int hashing(T item) {
    	int hash = item.hashCode() % initSize;
    	return hash;
    }
